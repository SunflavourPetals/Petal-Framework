...
public:
	static int main()
	{
		using namespace Petal;
		{
			...
			std::cin >> fmt_str;
			char fmt[128]{};
			strcpy_s(fmt, 128, fmt_str.c_str());
			const_print("{}{}", "cnm", 123);
			Debug::println();
			const_print(fmt, "cnm", 123);
			Debug::println();
		}
	...
	//	std::basic_string_view<char>;
		std::unordered_map<CStringRef, int> axxa;
		...
		w.Create(WindowClassArgs{ Petal_TStr("my_win_class") }.Register().class_atom, { Petal_TStr("My Window") });
